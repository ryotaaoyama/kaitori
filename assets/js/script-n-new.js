$('input').click(function(){
  $('input').blur();
		...
		// 表示・非表示を切り替える要素を取得
const showFirst = document.querySelector(".slider2")
// 表示・非表示を切り替える関数
            ...
            if (tabName === 'brand') {
                ...
                data.forEach(function (item) {
                    ...
                    if (matt === '49' || matt === '46' || matt === '53' || matt === '47' || matt === '48' || matt === '42' || matt === '41' || matt === '50' || matt === '44') {
                        carOneList.push('<li><a onclick="selectBrand(\'' + brand + '\')"><img src="' + logo + '" alt="' + listItem + '" /><div>' + brand + '</div></a></li>');
                    } else if (matt === '30' || matt === '25' || matt === '20' || matt === '22' || matt === '28' || matt === '57' || matt === '63' || matt === '04') {
                        carTwoList.push('<li><a onclick="selectBrand(\'' + brand + '\')"><img src="' + logo + '" alt="' + listItem + '" /><div>' + brand + '</div></a></li>');

                    } else if (matt === '19' || matt === '90' || matt === '21' || matt === '01' || matt === '58' || matt === '79' || matt === '06' || matt === '07') {
                        caroneItem.push('<li><a onclick="selectBrand(\'' + brand + '\')">' + brand + '</li>');

                    } else if (matt === '40' || matt === '92' || matt === '08' || matt === '33' || matt === '02' || matt === '46' || matt === '34' || matt === '23' || matt === '72' || matt === '73') {
                        cartwoItem.push('<li><a onclick="selectBrand(\'' + brand + '\')">' + brand + '</li>');

                    } else if (matt === '59' || matt === '60' || matt === '09') {
                        carthreeItem.push('<li><a onclick="selectBrand(\'' + brand + '\')">' + brand + '</li>');

                    } else if (matt === '61' || matt === '56' || matt === '03' || matt === '62' || matt === '10' || matt === '93' || matt === '94' || matt === '95' || matt === '24' || matt === '43' || matt === '74') {
                        carfourItem.push('<li><a onclick="selectBrand(\'' + brand + '\')">' + brand + '</li>');

                    } else if (matt === '96' || matt === '64' || matt === '65' || matt === '11' || matt === '45' || matt === '97' || matt === '32' || matt === '75') {
                        carfiveItem.push('<li><a onclick="selectBrand(\'' + brand + '\')">' + brand + '</li>');

                    } else if (matt === '98' || matt === '78') {
                        carsixItem.push('<li><a onclick="selectBrand(\'' + brand + '\')">' + brand + '</li>');
                ...
                //var vehiclesPopup = document.getElementById('vehiclesPopup');
                //vehiclesPopup.innerHTML = '';
                var ninkiData = [];
                var numberData = [];
                var textaData = [];
                var textkaData = [];
                    ...
                    if (brandData) {
                        ...
                        if (vehicleData) {
                            ...
                            if (yearData) {
                                ...
                                versionList += '<li><a onclick="selectVersion(\'不明(ベースグレードでの査定となります)\')">不明(ベースグレードでの査定となります)</li>';
                ...
                var colorPopup = document.getElementById('colorPopup ul');
                colorPopup.innerHTML = '';
                colorPopup.classList.add('active');

            } else if (tabName === 'kilomet') {
                var kilometPopup = document.getElementById('kilometPopup ul');
                kilometPopup.innerHTML = '';
                kilometPopup.classList.add('active');

            } else if (tabName === 'status') {
                var statusPopup = document.getElementById('statusPopup status-content');
...
window.onload = function(){
    ...
    // Bắt sự kiện click để đóng popup (click bên ngoài popup)
    popup.addEventListener('click', function(event) {
        // Kiểm tra xem người dùng đã click vào nơi ngoài popup
