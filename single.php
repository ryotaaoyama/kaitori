...
<div class="brecum-content">
 ...
            <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to CTN一括査定." href="https://ctn-net.jp/kaitori/car" class="home" ><span property="name">CTN一括査定</span></a><meta property="position" content="1"></span>
  &gt; <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to the コラム" href="https://ctn-net.jp/kaitori/car/column/" class="taxonomy category" ><span property="name">クルマのあれこれ</span></a><meta property="position" content="2"></span>
   &gt;  <span property="itemListElement" typeof="ListItem"><span property="name"><?php echo the_title(); ?></span><meta property="url" content="<?php echo'https://' . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"];?>"><meta property="position" content="3">
        </div>
...
<section id="blog" class="blog abcb" data-aos="fade-up">
    <div class="container container-blog-custom">
        <div class="row g-5 post-cotent-cus">
            ...
            <aside id="secondary" class="widget-area col-lg-3 col-md-3 sidebar-ct">
